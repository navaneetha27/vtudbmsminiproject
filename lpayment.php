...
<div class="left">
  ...
  <a href="lpayment.php" class="active">Loan Payment</a><hr>
</div>
<div class="right">
<table align="center">
		<tr>
		<th colspan="6" class="hdr"><center>PAYMENTINFO</center></th>
		</tr>
		<tr>
		<th>UID </th>
		...
		while($rows=mysqli_fetch_array($result)){
			...
			<td><a href='update1.php?uid=<?php echo $rows['uid'].'&' ;?>appno=<?php  echo $rows['appno'];?>'>UPDATE/Edit</td>
			</tr>
			<?php
		}?>
		</table>
